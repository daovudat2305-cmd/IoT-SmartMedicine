...
public class ActionController {
    ...
    public ApiResponse<PageResponse<ActionHistoryResponse>> getActionHistory(
        ...
        @RequestParam (required = false) @DateTimeFormat (iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime datetimeFrom,
        @RequestParam (required = false) @DateTimeFormat (iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime datetimeTo,
        ...
        PageResponse<ActionHistoryResponse> response = actionService.getActionHistory(deviceId, action, status, datetimeFrom, datetimeTo, safePage, safeSize, sort);
